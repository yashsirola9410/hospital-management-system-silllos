...
public class HospitalManagementSystem {
    ...
    private static final String password = "#Yash2004";

    public static void main(String args[]) throws ClassNotFoundException, SQLException{
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");  //Registers the MySQL JDBC driver to enable the Java program to connect to the database.
    ...
    public static void bookAppointment(Patients patients , Doctor doctor , Connection connection , Scanner scanner){
         ...
         if(patients.getPatientByID(patientId) && doctor.getDoctorByID(doctorId)){
             ...
             System.out.println("Enter a valid patient and doctor");
         }
